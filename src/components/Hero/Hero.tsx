...
const grandpa1 = "/images/grandpas/Grandpa1.png";
const grandpa2 = "/images/grandpas/Grandpa2.png";
const grandpa3 = "/images/grandpas/Grandpa5.png";
    ...
    <section className={css.section}>
        ...
        <div ref={box99Ref}>
          <div className={`${css.text1} ${css.textBox1}`}>
            <p>
              ...
              Я - твій <span className={css.bold}>френдлі Дідусь.</span>{" "}
              Сьогодні покажу тобі мою затишну домівку, проведу сторінками
              казкового місця сили, тиші та спокою. Я створив цю садибу для
              твого <strong>еко відпочинку</strong>, щоб в потрібний момент ти
              міг зупинити думки,насолодитись природою, прислухатись до себе та
              створити нові приємні спогади.
            </p>
          </div>
      ...
      <div className={`${css.textContainer}`} ref={box3Ref}>
        <p className={css.text1}>
          ...
          <span className={css.bold}>найкраще місце на Землі -</span>{" "}
          <strong>еко-садибу “На селі у Дідуся”</strong>.
        </p>
        <p className={css.text1}>
          {" "}
          ...
          ліса, надзвичайні{" "}
          <span className={css.bold}>Блакитні озера - справжня казка,</span> від
      ...
      <div className={css.textContainer1} ref={box4Ref}>
        ...
        <p className={css.text1}>
          ...
          Так була створена{" "}
          <strong>еко-садиба у селі Олешня Чернігівської області</strong>. Мій
          неповторний рідний край став натхнення для народження{" "}
      ...
      <div className={css.textContainer2}>
        ...
        <div ref={box7Ref}>
          <h2 className={`${css.title1} ${css.add1}`}>
            Тут час збирає спогади
          </h2>
          <p className={css.text1}>
            Я знаю, що сучасний світ насичений стресом та проблемами. Але «На
            селі у Дідуся» не існує цих слів. Справжній еко відпочинок -
            природа, свіже повітря, величний ліс та кристально чисте блакитне
            озеро змусять тебе
