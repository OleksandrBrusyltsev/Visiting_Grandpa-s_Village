...
const IconAsk = ({ className }: { className: string }) => {
  ...
  return isMobile ? <svg className={className} viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M3.57195 32.557C3.62436 32.3216 3.58993 32.0751 3.47499 31.8631C1.86406 28.8913 1.00633 25.4816 1 21.9989C1.00049 10.3318 10.4063 1 22 1C33.594 1 43 10.3323 43 21.9998C43 33.6673 33.594 42.9996 22 42.9996L21.9941 42.9996C17.7921 43.0245 13.6598 41.7346 10.0705 39.2648C9.79202 39.0732 9.43562 39.0352 9.12305 39.1639L1.39284 42.3451L3.57195 32.557Z" fill="currentColor" stroke="#3F5540" strokeWidth="2" strokeLinejoin="round" />
  ...
  return (
    ...
    >
      <div className={style.headlineWrapper} ref={headlineWrapperRef}>
        <p className={style.headline}>{t('askGrandpa')}</p>
