export const meals = [
    {
        id: 0,
        title: {
            uk: 'Нарешті, моє улюблене -&nbsp;Їжа. Поїмо ?',
            ru: 'Наконец, мое любимое -&nbsp;еда. Поедим?',
            en: 'Finally, my favorite thing is&nbsp;food. Shall&nbsp;we&nbsp;eat?',
        },
        description: {
            uk: 'давай вже\nскоріш їсти',
            ru: 'давай уже\nскорее кушать',
    ...
    },
    {
        ...
        description: {
            ...
            en: "The grills on the territory of the *[eco-estate “At the Grandpa's village”](/)* **are included in the accommodation price.** Light the fire, cook your favorite *eco-style dishes,* and enjoy the taste while surrounded by greenery and flowers, amidst incredible nature and fresh forest air.\n\n The atmosphere here will make the food even tastier and provide unforgettable emotions.",
        },
        photo: [
