export const entertainments = [
    {
        id: 0,
        title: {
            uk: 'База відпочинку для незабутніх спогадів',
            ru: 'База отдыха для незабываемых воспоминаний',
            en: 'Recreation center for unforgettable memories',
        },
        subtitle: {
            uk: 'Як саме?',
            ru: 'Как именно?',
        ...
        quote: {
            uk: '“Мистецтво Відпочинку - не завжди означає Дію, навчись нічого не робити, а просто насолодись тишею та спокоєм.”',
    ...
    },
    {
        ...
        title: {
            uk: 'відчуй атмосферу',
            ru: 'почувствуй атмосферу',
            en: 'feel the atmosphere',
        },
        subtitle: {
            uk: '',
            ru: '',
